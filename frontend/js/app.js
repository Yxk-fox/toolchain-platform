...
(function() {
  ...
  function renderTools(content) {
    loadAllData().then(function() {
      ...
      var allTags = d.toolTags || [];
      
      var baseFilteredTools = d.tools.filter(function(t) {
      ...
      var usedTags = {};
      baseFilteredTools.forEach(function(t) {
      ...
      if (appState.currentTag && tags.indexOf(appState.currentTag) === -1) {
        appState.currentTag = '';
      }
      
      var filteredTools = baseFilteredTools.filter(function(t) {
