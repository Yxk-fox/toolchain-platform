# 数据备份 - 2026-08-18 22:59:12

- **备份时间**：2026-08-18T22:59:12
- **备份目录**：`/home/fox/toolchain-platform/ck/data/bk/2026/08/18`
- **保留天数**：7 天
- **模块数量**：8
...
|---|---|---|---|---|
| `userdata.json` | user | 4.48 KB | `a847f3ca124df3c9` | users=8, tokens=4, permission_grants=0 |
...
| `errordata.json` | error | 6.04 MB | `7a9beff8c54c0f80` | alerts=7619, inspection_history=1000, recycle_requests=0 |
