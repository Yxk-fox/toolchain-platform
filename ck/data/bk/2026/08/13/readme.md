# 数据备份 - 2026-08-13 22:59:03

- **备份时间**：2026-08-13T22:59:03
- **备份目录**：`/home/fox/toolchain-platform/ck/data/bk/2026/08/13`
- **保留天数**：7 天
- **模块数量**：8
...
| `appdata.json` | app | 93.30 KB | `01aac457c16e19c7` | tools=210, categories=2, tool_company_groups=13, favorites=3, user_favorites=3, history=48, quick_entries=0, user_quick_entries=0 |
| `errordata.json` | error | 4.53 MB | `3b73ee0b940e3125` | alerts=3368, inspection_history=1000, recycle_requests=0 |
| `servicedata.json` | service | 12.99 KB | `f8b0988be8e5c2b4` | services=18, service_dependencies=0 |
| `envdata.json` | env | 6.39 KB | `a4909fb43d75fb91` | envs=22, env_groups=3 |
