# 数据备份 - 2026-08-20 22:59:27

- **备份时间**：2026-08-20T22:59:27
- **备份目录**：`/home/fox/toolchain-platform/ck/data/bk/2026/08/20`
- **保留天数**：7 天
- **模块数量**：8
...
|---|---|---|---|---|
| `userdata.json` | user | 4.19 KB | `b39d46ff42a85e02` | users=8, tokens=2, permission_grants=0 |
...
| `errordata.json` | error | 6.62 MB | `544260ca30bd661b` | alerts=9360, inspection_history=1000, recycle_requests=0 |
