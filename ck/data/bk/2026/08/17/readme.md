# 数据备份 - 2026-08-17 22:59:17

- **备份时间**：2026-08-17T22:59:17
- **备份目录**：`/home/fox/toolchain-platform/ck/data/bk/2026/08/17`
- **保留天数**：7 天
- **模块数量**：8
...
| `errordata.json` | error | 5.75 MB | `f40a4c8beeb36629` | alerts=6755, inspection_history=1000, recycle_requests=0 |
