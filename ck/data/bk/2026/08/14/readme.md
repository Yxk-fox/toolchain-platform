# 数据备份 - 2026-08-14 22:59:28

- **备份时间**：2026-08-14T22:59:28
- **备份目录**：`/home/fox/toolchain-platform/ck/data/bk/2026/08/14`
- **保留天数**：7 天
- **模块数量**：8
...
|---|---|---|---|---|
| `userdata.json` | user | 4.34 KB | `5422d7b3cd542bc4` | users=8, tokens=3, permission_grants=0 |
...
| `errordata.json` | error | 4.91 MB | `782d55f4215df6ea` | alerts=4216, inspection_history=1000, recycle_requests=0 |
